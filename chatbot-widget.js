(function () {
  ...
  async function initializeConversation(showLoading = false) {
    ...
    async function confirmSendMedia(caption) {
      ...
      // Ensure we display latest state from backend (including bot replies)
      await fetchAndRenderThreadAfterSend();
  ...
  async function sendMessageToApi(text) {
    ...
    try {
      ...
      // Send message to API - this happens in background from user's perspective
